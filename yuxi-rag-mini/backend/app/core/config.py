...
class Settings(BaseSettings):
    ...
    DATABASE_URL: str = ""  # For PostgreSQL, e.g. postgresql+asyncpg://user:pass@localhost:5432/yuxi_rag
    ...
    # Embedding
    EMBEDDING_PROVIDER: Literal["openai_compatible", "ollama", "huggingface"] = "openai_compatible"
